...
export default function AdminOverviewPage() {
  return (
    <>
      ...
      {!supabaseConfigured && (
        <div className="mt-8 rounded-sm border border-blush bg-blush/40 p-5">
...
function Card({ href, title, body }: { href: string; title: string; body: string }) {
  return (
    <Link
      href={href}
      className="block rounded-sm border hairline bg-paper p-6 transition-colors hover:border-moss"
    >
